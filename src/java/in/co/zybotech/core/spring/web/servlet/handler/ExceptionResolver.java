package in.co.zybotech.core.spring.web.servlet.handler;
...
public class ExceptionResolver extends SimpleMappingExceptionResolver {
	...
	private ExceptionMetadata getMetadata(Class<?> clazz) {
		...
		if (metadata == null) {
			if (clazz
					.isAnnotationPresent(in.co.zybotech.core.exception.annotation.ExceptionMetadata.class)) {
				try {
					in.co.zybotech.core.exception.annotation.ExceptionMetadata annotation = clazz
							.getAnnotation(in.co.zybotech.core.exception.annotation.ExceptionMetadata.class);
